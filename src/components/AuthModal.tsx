                ...
                {sSuccess ? (
                  ...
                  <form onSubmit={handleSignup} className="mt-8 space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" required value={sNumber} onChange={(e) => setSNumber(e.target.value)} className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-[15px] outline-none transition focus:border-white/30 focus:bg-white/10" placeholder="Numéro de téléphone" />
                    </div>
